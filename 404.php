...
get_header(); ?>
  ...
  <article itemscope itemtype="http://schema.org/Article" role="article">
    ...
    <ul>
      <li><a href="<?php bloginfo( 'url' ); ?>" title="Aller sur la page d'accueil de <?php bloginfo( 'name' ); ?>"><?php echo __('Retourner à l\'accueil', 'ffeeeedd'); ?></a></li>
      <li><?php echo __('Consulter le plan du site', 'ffeeeedd'); ?></li>
      <li><a href="mailto:<?php echo antispambot( bloginfo( 'admin_email' ) ); ?>" title="Envoyer un message à l'administrateur"><?php echo __('Contacter l\'administrateur du site', 'ffeeeedd'); ?></a></li>
    </ul>
  </article>
