...
<?php if ( have_posts() ): ?>
  ...
  <?php if ( is_day() ) : ?>
    <h2><?php echo __('Archive', 'ffeeeedd'); ?> : <?php echo  get_the_date( 'j F Y' ); ?></h2>
  <?php elseif ( is_month() ) : ?>
    <h2><?php echo __('Archive', 'ffeeeedd'); ?> : <?php echo  get_the_date( 'F Y' ); ?></h2>
  <?php elseif ( is_year() ) : ?>
    <h2><?php echo __('Archive', 'ffeeeedd'); ?> : <?php echo  get_the_date( 'Y' ); ?></h2>
  <?php else : ?>
